...
let indexProducto = JSON.parse(fs.readFileSync(path.resolve(__dirname,"..", "data",`${req.query.type}.json`)));
    //res.sendFile(path.resolve(__dirname, "..", "views", "web", "index.html"));
    res.render(path.resolve(__dirname, "..", "views", "admin", fileViewName),{indexProducto});

},

createHabanos: (req, res) => {
//Aca pasamos los datos del archivo Json de Habanos a un Array
let productoHabanos = JSON.parse(fs.readFileSync(path.resolve(__dirname,"..", "data",`${req.query.type}.json`)));
    //res.sendFile(path.resolve(__dirname, "..", "views", "web", "index.html"));
